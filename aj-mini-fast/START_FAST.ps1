...
Write-Host "   AJ API FAST - STARTING UP" -ForegroundColor Green
Write-Host "   Lightweight & Fast Version" -ForegroundColor Yellow
...
Write-Host "[1/3] Starting API Server (Port 5000)..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host ""
    Write-Host "====================================================" -ForegroundColor Cyan
    Write-Host "   AJ FAST SERVER READY!" -ForegroundColor Green
    Write-Host "====================================================" -ForegroundColor Cyan
    Write-Host ""
